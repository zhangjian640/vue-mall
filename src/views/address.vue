      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item, index) in addressListFilter" :class="{'check': checkIndex === index}" @click="checkIndex = index;selectedAddId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      expand () {
        if (this.limit === ADDRESS_COUNT) {
          this.limit = this.addressList.length
        } else {
          this.limit = ADDRESS_COUNT
        }
      },
